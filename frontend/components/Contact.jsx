    ...
    <section className="pt-[110px] pb-[100px] text-center" id="contact">
      <div className="max-w-[1180px] mx-auto px-8">
        ...
        <p className="mt-[22px] mx-auto max-w-[480px] text-[16.5px] text-ink-soft leading-relaxed">
          Send a message and we'll follow up within one business day — no pressure, no
          obligation.
        </p>
        ...
        >
            ...
            <label className="flex flex-col gap-1.5 text-[13.5px] font-semibold text-ink mb-4">
              Phone <span className="font-normal text-ink-soft normal-case">(optional)</span>
              <input
                type="tel"
                name="phone"
                value={form.phone}
            ...
            <div className="flex gap-4 flex-wrap">
              <button type="submit" className="btn btn-primary disabled:opacity-60 disabled:cursor-not-allowed" disabled={status === "sending"}>
                {status === "sending" ? "Sending…" : "Send message"}
              </button>
              <a href="tel:+16315550142" className="btn btn-ghost">Call (631) 555-0142</a>
            </div>
        ...
        <div className="mt-[46px] flex gap-10 justify-center flex-wrap text-[14.5px] text-ink-soft">
          <div>
            <strong className="block font-display text-[15px] text-ink mb-1">Office hours</strong>
            Mon–Fri, 9am–6pm
          </div>
          <div>
            <strong className="block font-display text-[15px] text-ink mb-1">Sessions</strong>
            In-person &amp; teletherapy
          </div>
          <div>
            <strong className="block font-display text-[15px] text-ink mb-1">Response time</strong>
