  ...
  return (
    <section className="bg-sage py-[90px]" id="about">
      <div className="max-w-[1180px] mx-auto px-8 grid grid-cols-1 md:grid-cols-2 gap-[60px] items-start">
        <Reveal>
          <span className="eyebrow">Personalized therapy, personalized results</span>
          ...
          <p className="mt-5 text-[16.5px] leading-[1.7] text-ink-soft">
            We treat both pediatric and adult clients, offering in-person and teletherapy
            sessions tailored to how each person communicates best. Every plan starts with
            a real conversation about what's getting in the way — and what progress should
            look like for you.
          </p>
        ...
        <Reveal className="bg-paper rounded-md2 px-8 py-[30px] shadow-soft">
          <h3 className="text-base font-bold tracking-wide mb-4">Most major insurance accepted</h3>
