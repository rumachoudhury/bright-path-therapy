...
const towns = ["Holbrook", "Riverhead", "Shirley", "Southampton", "+ surrounding areas"];

export default function Area() {
  return (
    <section className="py-[90px] bg-ink text-paper rounded-[40px] mx-3.5 md:mx-6" id="area">
      <div className="max-w-[1132px] mx-auto px-8 grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
        <Reveal>
          ...
          <p className="mt-[18px] text-base leading-[1.7] text-[#C9D6CF] max-w-[440px]">
            With offices and teletherapy reaching Holbrook, Riverhead, Shirley, Southampton
            and the surrounding areas — our team meets your family close to home, or online.
          </p>
          <div className="flex flex-wrap gap-2.5 mt-7">
            {towns.map((t) => (
              <span key={t} className="pill !bg-paper/5 !border-paper/20 !text-paper">
                {t}
              </span>
            ))}
          </div>
